...
package com.poc.teams.controller;
...
import com.poc.teams.utility.Utilities;

@Controller
public class TeamsPOCController {
	
	@Autowired
	private TeamsPOCService teamsPOCService;
    /**
    ...
    public String tokenDetails(Model model, @AuthenticationPrincipal OidcUser principal, @RegisteredOAuth2AuthorizedClient("azure") 
    	OAuth2AuthorizedClient authorizedClient) 
    {
    	teamsPOCService.createOAuthToken(authorizedClient);
